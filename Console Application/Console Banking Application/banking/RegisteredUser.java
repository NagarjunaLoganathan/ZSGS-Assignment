	...
	public void checkUser() {
		...
		if (NewUser.dbm.accCheck(accNo, password)) {
			...
			while (validation) {
				...
				switch (choice) {
				case 1 -> bank.getDepositAmount();
				case 2 -> bank.getWithdrawAmount();
				case 3 -> bank.getTransferMode();
				case 4 -> {
					Loan loan = new Loan();
					loan.getLoan();
				}
				case 5 -> bank.getUserInfo();
				case 6 -> bank.getMiniStatement();
				case 7 -> bank.deleteAccount();
				case 8 -> {
